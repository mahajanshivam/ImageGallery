...
public class CustomMaterialSearchView extends FrameLayout implements Filter.FilterListener {
    ...
    public CustomMaterialSearchView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs);
    ...
    private void initSearchView() {
        ...
        mSearchSrcTextView.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                mUserQuery = s;
                startFilter(s);
                CustomMaterialSearchView.this.onTextChanged(s);
            }
    ...
    private void startFilter(CharSequence s) {
        if (mAdapter != null && mAdapter instanceof Filterable) {
            ((Filterable) mAdapter).getFilter().filter(s, CustomMaterialSearchView.this);
        }
    }
